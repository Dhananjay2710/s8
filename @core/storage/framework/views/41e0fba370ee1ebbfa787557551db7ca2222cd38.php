                        ...
                        <div class="dashboard__headerContents__left">
                            ...
                            <?php if(moduleExists('Subscription') && $commissionGlobal->system_type == 'subscription'): ?>
                                  <?php if(!empty(auth('web')->user()->subscribedSeller)): ?>
                                    ...
                                    <?php else: ?>
                                   <div class="col-lg-12">
                                    <div class="alert alert-warning d-flex justify-content-between"><?php echo e(__('you must have to subscribe any of our package in service request to start selling your services.')); ?>
...
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/frontend/user/seller/services/partials/services-two.blade.php ENDPATH**/ ?>