...
@section('site-title')
    {{__('Service Request Create Settings')}}
@endsection
@section('content')
                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <div class="left-content">
                                <h4 class="header-title">{{__('Service Request Create Settings')}} </h4>
                            </div>
                        </div>
                        <form action="{{route('admin.order.create.settings.update')}}" method="post">
                            ...
                            <div class="tab-content margin-top-40">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" name="order_create_settings" id="order_create_settings" placeholder="{{__('Service Request Create Settings')}}">
