        ...
        <div class="dashboard__body">
            ...
            <div class="dashboard__inner__item dashboard_border padding-20 radius-10 bg-white">
                <div class="dashboard__wallet">
                    <form action="<?php echo e(route('seller.order.report.list')); ?>" method="GET">
                    <div class="dashboard__headerGlobal__flex">
                        <div class="dashboard__headerGlobal__content">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <h4 class="dashboard_table__title"><?php echo e(__('Search Report')); ?></h4> <i class="las la-angle-down search_by_all"></i>
                            </button>
                        </div>
                                                    ...
                                                    <div class="row g-4 mt-3">
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div class="single-info-input">
                                                                ...
                                                                <input class="form--control flatpickr_input"  name="report_date" type="text" value="<?php echo e(request()->get('report_date')); ?>" placeholder="<?php echo e(__('Created Date Range')); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="dashboard_table__wrapper dashboard_border  padding-20 radius-10 bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dashboard_table__main__actions">
                                                <a href="<?php echo e(route('seller.order.report.chat.admin',$report->id)); ?>" class="btn btn-info">
                    ...
                    <?php else: ?>
                        <div class="chat_wrapper__details__inner__chat__contents mt-3">
                            <h2 class="chat_wrapper__details__inner__chat__contents__para"><?php echo e(__('No Reports Found')); ?></h2>
                        </div>
                    <?php endif; ?>
                    <!-- reports section end -->
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/frontend/user/seller/report/partials/report-list-two.blade.php ENDPATH**/ ?>