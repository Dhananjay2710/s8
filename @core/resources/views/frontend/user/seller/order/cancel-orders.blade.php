                                    ...
                                    <table id="cancel_order_table" class="custom--table">
                                        <thead>
                                            <tr>
                                                ...
                                                @elseif(request()->path() == 'serviceprovider/orders/job/cancel-orders')
                                                    <!--job order title -->
                                                    <th> {{ __('Job Title') }} </th>
                                                    <th> {{ __('Service Request Date') }} </th>
                                                @else
                                        ...
                                        <tbody>
                                            @foreach ($cancel_orders as $order)
                                                <tr>
                                                    ...
                                                    @if ($order->status == 4) <td class="canceled" data-label="{{ __('Service Request Status') }}"><span>{{ __('Cancelled') }}</span></td>@endif
