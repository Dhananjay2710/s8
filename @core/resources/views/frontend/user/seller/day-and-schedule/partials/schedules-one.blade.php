                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                <h2 class="dashboards-title"> {{__('My Schedules')}} </h2>
                                <div class="notice-board">
                                    <p class="text-danger">{{ __('Your schedule will reflect your preferred time for assigning service requests.') }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 mt-5">
                            <form action="{{ route('seller.allow.multiple.schedule') }}" method="post">
                                ...
                                <div class="allow_multiple_schedule">
                                    ...
                                    @endphp
                                    <label class="total_day_label"> {{ __('Enable multiple service requests for the same schedule') }} </label>
                                    ...
                                    <p class="text-warning">{{ __('If you select Yes, multiple service requests will be scheduled for the same time') }}</p>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <span class="info">{{__('eg: 10:00Am - 11:00PM, this schedule time will show in frontend, when anyone want to book your service, they will select this schedule time made by you')}}</span>
                        </div>
