                            ...
                            <div class="dashboard__headerGlobal__flex">
                                <div class="dashboard__headerGlobal__content">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <h4 class="dashboard_table__title">{{ __('Search Ticket') }}</h4> <i class="las la-angle-down search_by_all"></i>
                                    </button>
                                </div>
                    ...
                    <div class="dashboard_table__title__flex">
                        ...
                        <div class="btn-wrapper" data-bs-toggle="modal" data-bs-target="#openTicket">
                            <a href="javascript:void(0)"
                               ...
                               data-bs-target="#ticketModal"><i class="fa-solid fa-plus"></i> {{__('Create Ticket For A Service Request' )}}</a>
                        </div>
                    </div>
