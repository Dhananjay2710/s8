...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Edit Customer Profile')); ?>
                                                ...
                                                <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="single-dashboard-input">
                                                        <div class="single-info-input margin-top-30">
                                                            ...
                                                            <textarea class="form--control textarea--form textarea-input" name="about" placeholder="<?php echo e(__('Type Note')); ?>"><?php echo e(Auth::guard('web')->user()->about); ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="single-dashboard-input">
                                                        <div class="single-info-input margin-top-30">
                                                    ...
                                                    <small class="text-danger"><?php echo e(__('recommended size 500x443')); ?></small>
                                                    <div class="single-dashboard-input">
                                                        <div class="single-info-input margin-top-30">
                                                            <div class="form-group">
                                                                <div class="media-upload-btn-wrapper">
                                                    ...
                                                    <small class="text-danger"><?php echo e(__('recommended size 1394x315')); ?></small>
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/frontend/user/buyer/profile/buyer-profile-edit.blade.php ENDPATH**/ ?>