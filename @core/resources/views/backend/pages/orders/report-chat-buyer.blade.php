                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                <h3 class="dashboards-title"> {{__('Report Details')}} </h3>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                                ...
                                                @forelse($all_messages as $msg)
                                                    <div class="single-message-item @if($msg->type == 'seller') customer @endif">
                                                        <div class="top-part">
                                                            ...
                                                            <span class="title">
                                                                 @if($msg->type == 'buyer')
                                                                    {{substr(optional($report_details->buyer)->name ?? 'B',0,1)}}
                                                                @else
                                                                    <span>{{ __('A')}}</span>
                                                                @endif
                                                            </span>
                                        ...
                                        <div class="reply-message-wrap ">
                                            <h4 class="title">{{__('Reply To Message')}}</h4>

                                            <x-msg.success/>
                                            <x-msg.error/>

                                            <form action="{{route('admin.order.report.chat.buyer',$report_details->id.'/'.$report_details->buyer_id)}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="" class="message_buyer_seller_text_title_color">{{__('Message')}}</label>
