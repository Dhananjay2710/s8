...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title> <?php echo e(__('Service Request Invoice')); ?> </title>
...
<body>
    ...
    <div class="invoice-area">
        <div class="invoice-wrapper">
            ...
            <div class="invoice-details" style="margin-bottom:100px">
                    ...
                    <table class="custom--table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="data-span"> <?php echo e($order_details->id); ?></span><br>
                                ...
                                <td>
                                   ...
                                   <span class="data-span"> <?php echo e(__('Payment Method:')); ?> </span <?php echo e(__(ucwords(str_replace("_", " ", $order_details->payment_gateway)))); ?> <br> 
...
<?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/frontend/user/seller/order/order-invoice.blade.php ENDPATH**/ ?>