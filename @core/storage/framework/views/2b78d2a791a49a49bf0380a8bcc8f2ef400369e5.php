                            ...
                            <table class="table table-default">
                                ...
                                <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <p><strong><?php echo e(__('Report From:')); ?></strong> <?php echo e(ucfirst($data->report_from)); ?></p>
                                            <p><strong><?php echo e(__('Report To:')); ?></strong> <?php echo e(ucfirst($data->report_to)); ?></p>
                                            <p><strong><?php echo e(__('Report Date:')); ?></strong> <?php echo e(date('d-m-Y', strtotime($data->created_at))); ?></p>
                                            <p><strong><?php echo e(__('Description:')); ?></strong> <span class="btn btn-info btn-sm report_description" data-toggle="modal" data-target="#reportModal" data-report="<?php echo e($data->report); ?>"><i class="ti-eye"></i></span></p>
                                        </td>
                                        <td>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/backend/pages/orders/seller-buyer-report.blade.php ENDPATH**/ ?>