    ...
    (function ($){
        ...
        $(document).ready(function (){
            ...
            $(document).on('click', '.wallet_selected_payment_gateway',function(){
                ...
                if($('.wallet-payment-gateway-wrapper').is(':checked')){
...
</script><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/components/payment-gateway-js.blade.php ENDPATH**/ ?>