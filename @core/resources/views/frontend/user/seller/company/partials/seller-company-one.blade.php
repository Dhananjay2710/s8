                                ...
                                <div class="dashboard-profile-all">
                                    ...
                                    <div class="profile-info-dashboard margin-top-40">
                                        <div class="profile-btn-flex">
                                            <h2 class="dashboards-title"> {{ __('Company Information') }} </h2>
                                            <div class="btn-wrapper">
                                                <a href="{{route('seller.profile.edit')}}" class="cmn-btn btn-bg-1"> {{ __('Edit Company') }} </a>
                                            </div>
                                        </div>
