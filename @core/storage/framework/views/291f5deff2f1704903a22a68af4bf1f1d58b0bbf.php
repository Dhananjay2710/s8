        ...
        <div id="notfound">
            <div class="notfound">
                <div class="notfound-404">
                    ...
                    <h3><?php echo e(__('USER DOES NOT HAVE THE RIGHT PERMISSIONS.')); ?></h3>
                    <a href="<?php echo e(route('admin.home')); ?>"><?php echo e(__('back to Admin Dashboard')); ?></a>
                </div>
            </div>
        </div>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/errors/403.blade.php ENDPATH**/ ?>