...
<?php endif; ?>
                $('.table-wrap > table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "<?php echo e(route('admin.services')); ?>",
                    columns: [
                ...
                e.preventDefault();
                    Swal.fire({
                    title: '<?php echo e(__("Are you sure to Approve this service?")); ?>',
                    icon: 'warning',
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/backend/pages/services/index.blade.php ENDPATH**/ ?>