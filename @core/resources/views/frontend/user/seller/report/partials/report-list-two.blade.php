        ...
        <div class="dashboard__body">
            ...
            <div class="dashboard__inner__item dashboard_border padding-20 radius-10 bg-white">
                <div class="dashboard__wallet">
                    <form action="{{ route('seller.order.report.list') }}" method="GET">
                    <div class="dashboard__headerGlobal__flex">
                        <div class="dashboard__headerGlobal__content">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <h4 class="dashboard_table__title">{{ __('Search Report') }}</h4> <i class="las la-angle-down search_by_all"></i>
                            </button>
                        </div>
                                                    ...
                                                    <div class="row g-4 mt-3">
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div class="single-info-input">
                                                                ...
                                                                <input class="form--control flatpickr_input"  name="report_date" type="text" value="{{ request()->get('report_date') }}" placeholder="{{ __('Created Date Range') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="dashboard_table__wrapper dashboard_border  padding-20 radius-10 bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dashboard_table__main__actions">
                                                <a href="{{ route('seller.order.report.chat.admin',$report->id) }}" class="btn btn-info">
                    ...
                    @else
                        <div class="chat_wrapper__details__inner__chat__contents mt-3">
                            <h2 class="chat_wrapper__details__inner__chat__contents__para">{{ __('No Reports Found') }}</h2>
                        </div>
                    @endif
                    <!-- reports section end -->
                </div>
