                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.email.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="order_mail_success_message"><?php echo e(__('Service Request Mail Success Message')); ?></label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/backend/general-settings/email-settings.blade.php ENDPATH**/ ?>