<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Navbar Global Vartiant Settings')); ?>
...
<?php endif; ?>
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4"><?php echo e(__("Navbar Global Variants Settings")); ?></h4>
                        <form action="<?php echo e(route('admin.general.global.variant.navbar')); ?>" method="POST" enctype="multipart/form-data"><?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/backend/general-settings/navbar-global-variant.blade.php ENDPATH**/ ?>