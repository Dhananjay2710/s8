                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.login.register.settings.update')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="register_seller_title"><?php echo e(__('Register Page Service Provider Title')); ?></label>
                            ...
                            <div class="form-group">
                                <label for="register_buyer_title"><?php echo e(__('Register Page Customer Title')); ?></label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/backend/pages/services/login-register-settings.blade.php ENDPATH**/ ?>