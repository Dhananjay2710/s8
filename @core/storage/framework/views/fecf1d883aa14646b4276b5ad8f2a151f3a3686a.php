...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('All Deactive Users')); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title"><?php echo e(__('Deactivated Users')); ?></h4>
                                    <small><?php echo e(__('User list who deactivated their account from frontend.')); ?></small> <br><br>
...
<?php endif; ?></td>
                                                    ...
                                                    <td><?php echo e(optional($data->user)->email); ?></td>
                                                    <td><?php echo e($data->reason); ?></td>
                                                    <td>
                                                        <?php if($data->status == 0): ?>
                                                          <span class="btn btn-warning"><?php echo e(__('Deactivated')); ?></span>
                                                        <?php endif; ?>
                                                        <?php if($data->account_status == 1): ?>
                                                          <span class="btn btn-danger"><?php echo e(__('Deleted')); ?></span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><?php echo e($data->description); ?></td>
                                                        <td>  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-delete-user-account','data' => ['url' => route('admin.frontend.user.delete',$data->user_id )]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin-delete-user-account'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.frontend.user.delete',$data->user_id ))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
        ...
        (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('click','.swal_delete_button',function(e){
                    e.preventDefault();
                    Swal.fire({
                        title: '<?php echo e(__("Are you sure? permanently delete user account!")); ?>',
                        icon: 'warning',
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/backend/frontend-user/all-deactive-user.blade.php ENDPATH**/ ?>