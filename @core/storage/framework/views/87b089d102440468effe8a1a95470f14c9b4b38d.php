            ...
            <div class="dashboard__inner">
                ...
                <div class="dashboard__inner__item dashboard_border padding-20 radius-10 bg-white">
                    <div class="dashboard__wallet">
                        <form action="<?php echo e(route('buyer.support.ticket')); ?>" method="GET">
                                                        ...
                                                        <div class="row g-4 mt-3">
                                                            ...
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div class="single-info-input">
                                                                    ...
                                                                    <input class="form--control flatpickr_input"  name="ticket_date" type="date" placeholder="<?php echo e(__('Created Date Range')); ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <td>
                                    <div class="dashboard_table__main__status dropdown__status">
                                        <?php if($data->status === 'open'): ?>
                                            <a href="<?php echo e(route('buyer.support.ticket.view', $data->id)); ?>" class="dashboard_table__main__status__select dropdown__status__main Open"> <?php echo e(__('open')); ?></a>
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buyer-ticket-status-two','data' => ['url' => route('buyer.support.ticket.status.change',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                ...
                                <td>
                                    <div class="dashboard_table__main__actions">
                                        <a href="<?php echo e(route('buyer.support.ticket.view', $data->id)); ?>" class="icon"><i class="fa-regular fa-eye"></i></a>
                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ticket-delete-popup','data' => ['url' => route('buyer.support.ticket.delete',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                    ...
                    <?php else: ?>
                        <div class="chat_wrapper__details__inner__chat__contents mt-3">
                            <p class="no_data_found_for_buyer_seller_panel">
                                <?php echo e(__('No Tickets found')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/frontend/user/buyer/support-ticket/partials/tickets-two.blade.php ENDPATH**/ ?>