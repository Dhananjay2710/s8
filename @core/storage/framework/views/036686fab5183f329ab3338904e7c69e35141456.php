...
<?php $__env->startSection('content'); ?>
    ...
    <section class="category-services-area padding-top-70 padding-bottom-100">
        <div class="container">
            ...
            <div class="mb-4">
                <div class="col-lg-12">
                    <h2 class="section-sub-title"><?php echo e(sprintf(__('Available Service Sub Categories in %s'),$subcategory->name)); ?></h2>
                </div>
                        ...
                        <?php $__currentLoopData = $child_category_under_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-3 col-sm-6 margin-top-30 category-child">
                                <div class="single-category style-02 wow fadeInUp" data-wow-delay=".2s">
                                    <div class="icon category-bg-thumb-format" <?php echo render_background_image_markup_by_attachment_id($child_cat->image); ?>></div>
                                    <div class="category-contents">
                                        <h4 class="category-title"> <a href="<?php echo e(route('service.list.child.category',$child_cat->slug)); ?>"><?php echo e($child_cat->name); ?></a> </h4>
                                        <span class="category-para">  <?php echo e(sprintf(__('%s Service'),$child_cat->total_service)); ?> </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="services-contents">
                                    <ul class="author-tag">
                                        ...
                                        <?php if($service->reviews->where('type', 1)->count() >= 1): ?>
                                            <li class="tag-list">
                                                <a href="javascript:void(0)">
                                                <span class="reviews">
                                                    <?php echo ratting_star(round(optional($service->reviews->where('type', 1))->avg('rating'),1)); ?>

                                                    (<?php echo e(optional($service->reviews->where('type', 1))->count()); ?>)
                                                </span>
                                                </a>
                                            </li>
                                        <?php endif; ?>
    ...
    <script>
        (function($){
            ...
            $(document).on('click','#load_more_btn',function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('service.list.load.more.child.categories')); ?>",
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/frontend/pages/services/subcategory-services.blade.php ENDPATH**/ ?>