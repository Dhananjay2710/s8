    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="upload_media_image"
                               @if(get_static_option('dashboard_variant_buyer') == '02') data-{{$modalPrefix}}toggle="tab" @else data-toggle="tab" @endif
            ...
            <div class="modal-footer">
                <button type="button"
                class="btn btn-primary media_upload_modal_submit_btn" style="display: none">{{__('Set Image')}}</button>
            </div>
        </div>
    </div>
</div>