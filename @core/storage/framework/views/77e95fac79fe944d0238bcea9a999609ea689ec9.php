                        ...
                        <div class="dashboard_accountSettings__item">
                            <div class="dashboard_accountSettings__flex">
                                ...
                                <div class="dashboard_accountSettings__btn btn_flex">
                                    ...
                                    <?php if(!empty($user)): ?>
                                        <?php if($user->status === 0): ?>
                                            <a href="<?php echo e(route('seller.account.deactive.cancel',$user->user_id)); ?>" class="dashboard_table__title__btn btn-bg-deactivate radius-5"><?php echo e(__('Activate Your Account')); ?></a>
                                        <?php elseif($user->status === 1): ?>
    ...
    <div class="modal fade" id="deleteAccount" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="custom-form">
                        <form action="<?php echo e(route('seller.account.delete')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="row g-4">
                                <div class="col-12">
                                ...
                                <div class="col-12 mt-2">
                                    <div class="single-input">
                                        <label for="CurrentPassword" class="label_title__postition"><?php echo e(__('Delete reason')); ?></label>
                                        <div class="single-input-select radius-10">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/frontend/user/seller/profile/partials/account-settings-two.blade.php ENDPATH**/ ?>