                            ...
                            <div class="header-title d-flex">
                                <div class="btn-wrapper-inner">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pages-create')): ?>
                                         <a href="<?php echo e(route('admin.page.new')); ?>" class="btn btn-primary"><?php echo e(__('Add New Page')); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?></td>
                                            <td>
                                                ...
                                                <?php if($data->id != get_static_option('home_page') && $data->id != get_static_option('blog_page')): ?>
                                                 <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover-all-lang','data' => ['url' => route('admin.page.delete.lang.all',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                 <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.view-icon','data' => ['url' => route('frontend.dynamic.page',$data->slug)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pages-edit')): ?>
                                                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edit-icon','data' => ['url' => route('admin.page.edit',$data->id).'?lang='.$default_lang]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <?php if(!empty($data->page_builder_status)): ?>
                                                    <a href="<?php echo e(route('admin.dynamic.page.builder',['type' =>'dynamic-page','id' => $data->id])); ?>" target="_blank" class="btn btn-secondary mb-3 mr-1"><?php echo e(__('Open Page Builder')); ?></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
    ...
    <script type="text/javascript">
        (function(){
            ...
            $(document).ready(function(){
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action-js','data' => ['url' => route('admin.page.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/backend/pages/page/index.blade.php ENDPATH**/ ?>