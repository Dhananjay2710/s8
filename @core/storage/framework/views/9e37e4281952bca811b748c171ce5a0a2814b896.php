                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="single-checbox">
                                ...
                                <div class="checkbox-inlines">
                                    <label> <strong><?php echo e(__('Description:')); ?></strong>  </label> <p class="text-dark"><?php echo e(Str::limit(strip_tags($service->description),700)); ?></p>
                                </div>
                            </div>
                ...
                <div class="col-lg-5 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="border-bottom mb-3">
                                <h5><?php echo e(__('Service Benefits')); ?></h5>
                            </div>
                            <div class="single-checbox">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            <?php if($service->is_service_online == 1): ?>
                            <h5><?php echo e(__('Service Faqs: ')); ?></h5> <br>
                            <table class="table table-bordered">
                                <thead>
                                <tr>
                                    <th><?php echo e(__('Title')); ?></th>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/backend/pages/services/service-details.blade.php ENDPATH**/ ?>