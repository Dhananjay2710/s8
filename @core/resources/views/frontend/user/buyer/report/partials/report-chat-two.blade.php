        ...
        <div class="dashboard__inner">
            ...
            <div class="dashboard_table__wrapper dashboard_border  padding-20 radius-10 bg-white">
                <div class="dashboard_table__title__flex">
                    <h4 class="dashboards-title"> {{__('Report Details')}} </h4>
                </div>
                            ...
                            <div class="card-body">
                                <div class="gig-chat-message-heading">
                                    <div class="header-wrap d-flex justify-content-between">
                                        ...
                                        <a class="btn btn-primary btn-xs" href="{{ route('buyer.order.report.list')}}">{{__('All Reports')}}</a>
                                    </div>
                                    ...
                                    <div class="reply-message-wrap">
                                        ...
                                        <form action="{{route('buyer.order.report.chat.admin',$report_details->id)}}" method="post" enctype="multipart/form-data">
                                            @csrf
