            ...
            <div  class="add-service-content-wrapper mt-4">
                <div class="tab-content add-service-content" id="add-service-tabContent">
                   ...
                   <div wire:ignore.self class="tab-pane fade service_tab_hide_show
                    ...
                    <div wire:ignore.self class="tab-pane fade @if($current_tab === "service-set-availability-tab") show active @endif step" id="service-set-availability" role="tabpanel" aria-labelledby="service-set-availability-tab">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row g-4">
                                    <div class="col-lg-12">
                                            ...
                                            <div wire:ignore.self class="tab-pane fade active show" id="address-service" role="tabpanel" aria-labelledby="address-service-tab">
                                                <div class="single-settings">
                                                    <div>
                                                                        ...
                                                                        <div class="single-dashboard-input what-include-element mt-4">
                                                                            <div class="row align-items-center g-4">
                                                                                <div class="col-lg-4 col-sm-6">
                                                                                    <div class="single-info-input">
                                                                                        <label class="label_title">{{ __('Post Code') }} <span class="text-danger">*</span> </label>
                                                                                        <input class="form--control" type="number" wire:model.defer="include_service_postcode.{{ $key }}" placeholder="{{__('Post Code')}}">
                                                                                    </div>
                                                                                </div>
                                                                                <div class=" col-lg-2 col-sm-6 is_service_online_hide">
                                                        ...
                                                        <div  wire:ignore.self class="btn-wrapper mt-3">
                                                            <a href="javascript:void(0)" class="btn-see-more style-02 color-3 hide_service_and_show" wire:click="addAddressServices({{ $a_include }})"> {{__('Add More')}} </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
