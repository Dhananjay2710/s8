                    ...
                    <?php if(Auth::guard('web')->user()->notifications()->count() >= 1): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="list-order" href="<?php echo e(route('buyer.support.ticket.view',$notification->data['last_ticket_id'])); ?>">
                                                    ...
                                                    <?php echo e(__($notification->data['order_ticcket_message'])); ?> #<?php echo e($notification->data['last_ticket_id']); ?>

                                                </a>
                                            </td>
                                            <td>
                                                <div class="dashboard_table__main__actions">
                                                    <a href="<?php echo e(route('buyer.support.ticket.view',$notification->data['last_ticket_id'])); ?>" class="icon"><i class="fa-regular fa-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                  <?php endif; ?>
                        ...
                        <div class="blog-pagination margin-top-55">
                            <div class="custom-pagination mt-4 mt-lg-5">
                                <?php echo e(Auth::guard('web')->user()->notifications()->paginate(10)->links()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/frontend/user/buyer/notification/partials/notification-two.blade.php ENDPATH**/ ?>