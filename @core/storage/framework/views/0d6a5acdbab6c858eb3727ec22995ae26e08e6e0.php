                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if(!empty($data->order_id)): ?>
                                                <a class="btn btn-info btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('admin.orders.details', $data->order_id)); ?>">
                                                    <i class="ti-eye"></i>
                                                </a>
                                            <?php endif; ?>
                                          ...
                                          <?php if(!empty($data->job_post_id)): ?>
                                                <a class="btn btn-info btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('admin.ticket.details', $data->job_post_id)); ?>">
                                                    <i class="ti-eye"></i>
                                                </a>
                                            <?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/backend/pages/notifications/all-notification.blade.php ENDPATH**/ ?>