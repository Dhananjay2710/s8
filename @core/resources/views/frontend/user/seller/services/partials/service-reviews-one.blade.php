    ...
    <div class="dashboard__right">
        ...
        <div class="dashboard__body">
            <div class="dashboard__inner">
                            ...
                            <div class="dashboard__headerGlobal__flex">
                                <div class="dashboard__headerGlobal__content">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <h4 class="dashboard_table__title">{{ __('Search Review') }}</h4> <i class="las la-angle-down search_by_all"></i>
                                    </button>
                                </div>
                                                ...
                                                <div class="dashboard_jobPost__author__contents">
                                                    ...
                                                    <div class="dashboard_jobPost__views mt-3">
                                                        <div class="dashboard_jobPost__views__item">
                                                            <span class="dashboard_jobPost__views__para"><i class="las la-star review_color_two"></i> {{ __('Views') }}</span>
                ...
                @else
                    <h4 class="no_data_found text-dark">{{ __('No Review Found') }}</h4>
                @endif
            </div>
        </div>
        @endsection
