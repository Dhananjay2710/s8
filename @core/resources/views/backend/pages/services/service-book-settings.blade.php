                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.service.book.settings.update')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-danger">{{ __('This link will be set in service request confirmation terms and conditions.') }}</small>
                            ...
                            <div class="form-group">
                                <label for="service_order_confirm_title">{{__('Service Service Request Confirm Title')}}</label>
