...
<script>
    (function ($) {
        ...
        $(document).on('click','.media_upload_modal_submit_btn',function (e) {
            ...
            if( typeof allData != 'undefined'){
                ...
                $.each(allData,function(index,value){
                    ...
                    mainUploadBtn.parent().find('.img-wrap').append('<div class="img-inner-wrap"><div class="rmv-span" data-imageid='+el.imgid+'><i class="<?php echo e($trash_icon); ?>"></i></div><div class="attachment-preview"><div class="thumbnail"><div class="centered"><img src="'+el.imgsrc+'"></div></div></div></div>');
                });
        ...
        function deleteImage(type){
            $.ajax({
                type: "POST",
                url: "<?php echo e(route($type.'.upload.media.file.delete')); ?>",
                data: {
        ...
        $('body').on('click', '.media-uploader-image-list > li', function (e) {
            ...
            $('.img_alt_submit_btn').html('<i class="<?php echo e($check_icon); ?>"></i>');
        ...
        $(document).on('click', '.img_alt_submit_btn', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route($type.'.upload.media.file.alt.change')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        function loadAllImages() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route($type.'.upload.media.file.all')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on('click','#loadmorewrap',function (){
            ...
            $('#loadmorewrap button').append(' <i class="<?php echo e($spinner_icon); ?>"></i>'); //la spinner
            $.ajax({
                type: "POST",
                url: "<?php echo e(route($type.'.upload.media.file.loadmore')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    'skip' : skipp
                },
...
<?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/components/media/js.blade.php ENDPATH**/ ?>