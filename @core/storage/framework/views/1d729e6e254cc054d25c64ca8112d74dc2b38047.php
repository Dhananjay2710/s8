                        ...
                        <div class="single_seller_profile gray_bg">
                            ...
                            <div class="content_area_wrap">
                                <h4 class="title">
                                 ...
                                 <?php if(optional($seller->review->where('type', 1))->avg('rating') >=1): ?>
                                    <div class="profiles-review">
                                        <span class="reviews">
                                            <b><?php echo ratting_star(round(optional($seller->review->where('type', 1))->avg('rating'), 1)); ?></b>
                                            (<?php echo e(optional($seller->review->where('type', 1))->count()); ?>)
                                        </span>
                                    </div>
                                <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/frontend/pages/seller/all-seller.blade.php ENDPATH**/ ?>