      ...
      $(document).ready(function(){
        ...
        $(document).on('change','#service_city_id' ,function() {
          ...
          $.ajax({
            ...
            success: function(res) {
              if (res.status == 'success') {
                let alloptions = "<option value=''><?php echo e(__('Select Area')); ?></option>";
                let allList = "<li class='option' data-value=''><?php echo e(__('Select Area')); ?></li>";
...
<?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/frontend/partials/home-search.blade.php ENDPATH**/ ?>