...
} elseif ($_instance->childHasBeenRendered('eMPRj0f')) {
    $componentId = $_instance->getRenderedChildComponentId('eMPRj0f');
    $componentTag = $_instance->getRenderedChildComponentTagName('eMPRj0f');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eMPRj0f');
} else {
    $response = \Livewire\Livewire::mount('edit-service', ['editServiceId' => $edit_service_id,'edit_service_id' => $edit_service_id]);
    $html = $response->html();
    $_instance->logRenderedChild('eMPRj0f', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/frontend/user/seller/services/partials/edit-service-two.blade.php ENDPATH**/ ?>