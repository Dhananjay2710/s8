...
} elseif ($_instance->childHasBeenRendered('YH5gvzC')) {
    $componentId = $_instance->getRenderedChildComponentId('YH5gvzC');
    $componentTag = $_instance->getRenderedChildComponentTagName('YH5gvzC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YH5gvzC');
} else {
    $response = \Livewire\Livewire::mount('add-service', []);
    $html = $response->html();
    $_instance->logRenderedChild('YH5gvzC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/frontend/user/seller/services/partials/add-service-two.blade.php ENDPATH**/ ?>