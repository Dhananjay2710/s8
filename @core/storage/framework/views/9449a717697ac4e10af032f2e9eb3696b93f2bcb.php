                                            ...
                                            <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="single-slider">
                                                    <div class="gallery-images single-featured service-details-background-image"
                                                           <?php echo render_background_image_markup_by_attachment_id($img); ?>>
                                                    </div>
                                                </div>
                                                <?php endif; ?>
                                        ...
                                        <?php if(!empty($service_reviews)): ?>
                                            <?php $__currentLoopData = $service_reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="about-seller-flex-content style-02">
                                                    <div class="about-seller-thumb">
                                                        <a href="javascript:void(0)">
                                                            <?php if(empty(optional($review->buyer)->image)): ?>
                                                    ...
                                                    <div class="about-seller-content">
                                                        <a href="<?php echo e(route('about.buyer.profile',optional($review->buyer)->username)); ?>">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/frontend/pages/services/service-details.blade.php ENDPATH**/ ?>