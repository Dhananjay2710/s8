                                                ...
                                                <div class="confirm-bottom-content">
                                                        ...
                                                        <div class="single-checkbox">
                                                            <div class="checkbox-inlines">
                                                                <label class="checkbox-label" for="check2">
                                                                    <?php echo \App\Helpers\PaymentGatewayRenderHelper::renderPaymentGatewayForForm($service_details_for_book->is_service_online != 1,'old'); ?>
                                                    ...
                                                    <div class="checkbox-inlines bottom-checkbox terms-and-conditions">
                                                        ...
                                                        <label class="checkbox-label" for="check3"><?php echo e(__('I agree with')); ?>
                                                            ...
                                                            <a href="<?php echo e(url('/'.get_static_option('select_terms_condition_page'))); ?>" target="_blank"><?php echo e(__('terms and conditions *')); ?></a></label>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/frontend/pages/services/service-book.blade.php ENDPATH**/ ?>