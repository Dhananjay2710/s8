                            ...
                            <div class="header-title d-flex">
                                <div class="btn-wrapper-inner">
                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blog-create')): ?>
                                         <a href="<?php echo e(route('admin.blog.new')); ?>" class="btn btn-info"> <?php echo e(__('Add New')); ?></a>
                                         <a href="<?php echo e(route('admin.blog.trashed')); ?>" class="btn btn-danger"> <?php echo e(__('Trashed Blogs')); ?></a>
                                     <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
(function ($){
    ...
    $(document).ready(function () {
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action-js','data' => ['url' => route('admin.blog.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        $('.table-wrap > table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.blog',['lang' => $default_lang])); ?>",
            columns: [
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\v105\@core\resources\views/backend/pages/blog/index.blade.php ENDPATH**/ ?>