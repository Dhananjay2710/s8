...
class StaticOptionsTableSeeder extends Seeder
{
    public function run()
    {
        $fields = [
            ...
            'seller_report_subject'=>__('Service Provider New Report'),
            'seller_report_message'=>'<p>Hello,</p><p>New report is just created by a service provider. Please check , thanks</p><p>Report id: @report_id</p>',
            'seller_payout_subject'=>__('Service Provider Payout Request'),
            'seller_payout_message'=>'<p>Hello,</p><p>
                                         </p><div>
                                        </div><div>New payout request is just created by a service provider. Please check , thanks</div><div><br></div><div>
                                        </div><div>Payout request id: @payout_request_id</div><div>
                                        </div><p></p>',

            'seller_order_ticket_subject'=>__('New Service Request Ticket'),
            ...
            'seller_verification_subject'=>__('Service Provider Verification Request'),
            'seller_verification_message'=>'<p>Hello,</p><p>
                                             </p><div>
                                            </div><div>You have a new request for service provider verification.</div><div>
                                            </div><p></p>',
            'seller_extra_service_subject'=>__('Extra Service Added'),
            'seller_extra_service_message'=>'<p>Hello @seller_name</p><p>You have added extra service in your order.</p><p>Service Request id: @order_id</p>',
            ...
            'buyer_order_decline_subject'=>__('Service Request Complete Request Decline'),
            'buyer_order_decline_message'=>'<p>Your request to complete an service request has been decline by the buyer</p><p>Service Request id: @order_id</p>',
            'buyer_to_admin_extra_service_message'=>'<p>A buyer has been decline a request to complete an order.</p><div><br></div><div>Service Request id: @order_id</div><div>
                                                     </div><p></p>',
            ...
            'buyer_order_ticket_subject'=>__('New Service Request Ticket'),
            ...
            'buyer_extra_service_message'=>'<p>Hello @buyer_name</p><p>You have accepted extra service&nbsp; added by service provider in your order.</p><p>Service Request id: @order_id</p>',
            ...
            'admin_seller_verification_subject'=>__('Service Provider Verification Success'),
            'admin_seller_verification_message'=>'<p></p><p>Hello @name,</p><p>Your verification is success. Now you are a verified service provider.</p><p>
                                                    </p><p></p> <p></p>',
            ...
            'new_order_buyer_message'=>'<p>You have successfully placed an service request #</p>',
            'new_order_admin_seller_message'=>'<p>You have a new service request #</p><div>
                                                </div><p></p>',
            ...
            'buy_subscription_admin_message'=>'<p>A Service Provider just buy a subscription</p><p>Subscription infos---
                                                </p><p>Subscription type: @type
                                                </p><p>Subscription price: @price
                                                </p><p>Subscription connect: @connect</p><p>Service Provider name: @seller_name</p><p>Service Provider email: @seller_email</p>',
            ...
            'renew_subscription_admin_message'=>'<p>A service provider just renew his subscription</p><p>
                                                     <div>
                                                    </div><div>Subscription infos---
                                                    </div><div>Subscription type: @type
                                                    </div><div>Subscription price: @price
                                                    </div><div>Subscription connect: @connect
                                                    </div><div>Service Provider name: @seller_name
                                                    </div><div>Service Provider email: @seller_email</div><div>
                                                    </div><div>
                                                    </div><div>
                                                    </div><div>
                                                    </div><div>
            ...
            'customer_register_message' => '<p>Hello @name,</p><p>You have been registered as a customer</p><p>Credentials are as follows</p><p>Username: @username</p><p>Password: @password</p>',
            'customer_register_message_subject' => __('Welcome to S8'),    
            ];
