...
<?php endif; ?>
    <style>
        .dropdown-item + .note-icon-menu-check:before {
            visibility: hidden;
            opacity: 0;
            display: none;
        }
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\v105\@core\resources\views/backend/page-builder/dynamicpage.blade.php ENDPATH**/ ?>