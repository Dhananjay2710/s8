        ...
        <div class="container">
            ...
            <div class="mb-2">
              ...
              <?php if($subcategory_under_category->count() >20): ?>
                  <div class="load_more_button_warp"><a href="#" id="load_more_btn" data-total="20"><?php echo e(__('Load More')); ?></a></div>
              <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/frontend/pages/services/category-services.blade.php ENDPATH**/ ?>