                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.reading')); ?>" method="POST" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                               ...
                               <div class="form-group">
                                    <label for="site_logo"><?php echo e(__('Service List Page')); ?></label>
                                    <select name="service_list_page" class="form-control">
                                        
                                        <?php $__currentLoopData = $all_home_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        
                                            <option value="<?php echo e($page->id); ?>" <?php if($page->id == get_static_option('service_list_page')): ?>  selected <?php endif; ?>><?php echo e($page->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>

                               <div class="form-group">
                                   <label for="site_logo"><?php echo e(__('Blog Page')); ?></label>
                              ...
                              <div class="form-group">
                                   <label for="site_logo"><?php echo e(__('Price Plan Page')); ?></label>
                                   <select name="price_plan_page" class="form-control">
                                       <?php $__currentLoopData = $all_home_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           <option value="<?php echo e($page->id); ?>" <?php if($page->id == get_static_option('price_plan_page')): ?>  selected <?php endif; ?>><?php echo e($page->title); ?></option>
                                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   </select>
                             </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pinpointplus/s8/@core/resources/views/backend/general-settings/reading.blade.php ENDPATH**/ ?>