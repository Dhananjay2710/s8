                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="single-checbox">
                                ...
                                <br>
                                <div class="checkbox-inlines">
                                    <p><strong><?php echo e(__('Service Provider Note: ')); ?></strong><?php echo e($request_details->seller_note); ?></p>
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\s8\@core\resources\views/backend/pages/payout-request/payout-request-details.blade.php ENDPATH**/ ?>